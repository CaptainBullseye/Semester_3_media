//poging om de vorm waar de lijnen omheen draaien te weergeven.
...
//****************************** Derde ******************************//
  ...
  line(x6(t - q), y6(t - q), x5(t - q), y5(t - q));
  }
...
for(int z = 0; z < NUM_LINES; z++) {
  line(x8(t - z), y8(t - z), x7(t - z), y7(t - z));
  }
...
float x9(float r) {
return sin(r/10) * 100 + sin(r/5) * 20;  
}
